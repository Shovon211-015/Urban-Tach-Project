                    ...
                    <div class="col-2 fixed-div">
                        <div class="h-100 bg-secondary rounded p-4">
                            ...
                            <div class="list-group">
                                <a href="#" id="loadForm" class="list-group-item list-group-item-action">Add House Details</a>
                                <a href="#" id="loadFormEdit" class="list-group-item list-group-item-action">Edit House Details</a>
                                <a href="#" id="houseDelet" class="list-group-item list-group-item-action">Delete House Info</a>
                    ...
                    <div class="col-10">
                        <div class="h-100 bg-secondary rounded p-4">
                            ...
                            <div class="row">
                                ...
                                //$query = "SELECT houseId, name, image, date, time, amount FROM renthouse ORDER BY id ASC"; ----------Rent Card;
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="btn-group d-flex mb-0">
                                                    ...
                                                    <button id="<?php echo $buttonId; ?>" class="btn <?php echo $houseExists ? 'btn-danger' : 'btn-success'; ?> flex-fill" <?php //echo $houseExists ? 'disabled' : ''; ?>>
                                                        <?php echo $houseExists ? '<span style="color: white;">Details, or Release</span>' : 'Details, or Release'; ?>
                                                    </button>
                                                    <script>
                                                        ...
                                                        rentButton_<?php echo $houseId; ?>.addEventListener('click', function() {
                                                            window.location.href = 'releaseHouse.php?id=<?php echo $houseId; ?>'; // Pass houseId as a parameter
                                                        });
                                                    </script>
