            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="dob" name="dob" value="<?php echo $currentDate; ?>" readonly>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" class="form-control" id="startDate" name="startDate" value="<?php echo $currentDate; ?>" readonly>
                    </div>
                </div>
                ...
                <script>
                    document.getElementById('rentDuration').addEventListener('input', function() {
                        var startDate = document.getElementById('startDate').value;
                        var rentDuration = document.getElementById('rentDuration');

                        rentDuration.min = startDate; // Set the minimum date for rent duration as the selected start date
                    });
                </script>
