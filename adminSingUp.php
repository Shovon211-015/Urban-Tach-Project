        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
            <div class="row jumbotron box8">
                ...
                <div class="col-sm-6 form-group">
                    ...
                    <input type="text" class="form-control" name="fname" id="name-f" placeholder="Enter your first name." required pattern="[A-Za-z]+" title="Please enter letters only for the first name.">
                    <!-- 'pattern' attribute with [A-Za-z]+ allows only alphabetic characters -->
                </div>
                <div class="col-sm-6 form-group">
                    <label for="name-l">Last name</label>
                    <input type="text" class="form-control" name="lname" id="name-l" placeholder="Enter your last name." required pattern="[A-Za-z]+" title="Please enter letters only for the last name.">
                    <!-- 'pattern' attribute with [A-Za-z]+ allows only alphabetic characters -->
                </div>
