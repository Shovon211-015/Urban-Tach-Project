    ...
    <div class="container-fluid position-relative d-flex p-0">
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="sidebarCall" id="sidebarCall">
                        ...
                        <a href="ctzRent.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Spectacular Place</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <!--<div class="row g-4"> ------------------------------------------------- Bad me spectacular place setting ko dekumgi
                    <div class="col-2">
                    ...
                    <div class="col-12">
                        <div class="h-100 bg-secondary rounded p-4">
                            ...
                            <div class="row">
                                ...
                                $query = "SELECT houseId, image, date, time, amount FROM spectacularplace ORDER BY id DESC";
                                ...
                                if ($queryfire) {
                                    while ($product = mysqli_fetch_assoc($queryfire)) {
                                        ...
                                        // Query to check if the houseId exists in the spectacularplace table
                                        $checkQuery = "SELECT * FROM spectacularplace WHERE houseId = $houseId";
