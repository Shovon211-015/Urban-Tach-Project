                                ...
                                <div class="shopping-cart">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><img src="<?php echo $fetch_cart['image']; ?>" height="100px" alt=""></td>
                                                        ...
                                                        <td><a href="indexAdmin.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('remove item from cart?');">remove</a></td>
                                                    </tr>
                                            <?php
                                            ...
                                            <tr class="table-bottom">
                                                ...
                                                <td><a href="indexAdmin.php?delete_all" onclick="return confirm('delete all from cart?');" class="delete-btn <?php echo ($grand_total > 1) ? '' : 'disabled'; ?>">delete all</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
