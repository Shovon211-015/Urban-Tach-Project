...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $targetFile)) {
            ...
            // SQL query to insert data into the spectacularplace table
            $sql = "INSERT INTO spectacularplace (houseId, name, image, date, time, amount) 
...
<body>
    <div class="container mt-4">
        ...
        <div class="addHouseinto">
            <h1 class="mb-4 addHouse"> Spectacular Place Information</h1>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        <label for="name" class="form-label">Name (who added the place)</label>
                        <input type="text" class="form-control" id="clock" name="clock" required>
                    </div>
                </div>
            </div>
