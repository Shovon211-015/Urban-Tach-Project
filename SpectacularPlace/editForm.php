                        ...
                        <div class="container">
                            <form action="editForm.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            <label for="name" class="form-label">Edited By</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="date" name="date" value="' . $row['date'] . '" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="time" name="time" value="' . $row['time'] . '" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-3">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
        ...
        if (isset($_FILES["image"]) && $_FILES["image"]["error"] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
                ...
                $sql = "UPDATE spectacularplace SET name='$name', image='$targetFile', date='$date', time='$time', amount='$amount' WHERE houseId='$houseId'";
            ...
            $sql = "UPDATE spectacularplace SET name='$name', date='$date', time='$time', amount='$amount' WHERE houseId='$houseId'";
            if ($conn->query($sql) === TRUE) {
