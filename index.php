...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <a href="#" id="loadPage"><div class="bg-secondary  rounded d-flex align-items-center justify-content-between p-4">
                ...
                <!--citizen registration-->
                    <div class="col-sm-6 col-xl-3">
            <a href="" id="loadPage3"><div class="bg-secondary d-flex align-items-center justify-content-between p-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
            <a href="" id="loadPage2"><div class="bg-secondary d-flex align-items-center justify-content-between p-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
            <a href="" id="loadPage4"><div class="bg-secondary d-flex align-items-center justify-content-between p-4">
