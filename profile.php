            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Profile</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="button.php" class="dropdown-item">Buttons</a>
                            <a href="typography.php" class="dropdown-item">Typography</a>
                            <a href="profile.php" class="dropdown-item active">Other Profile</a>
                        </div>
                    </div>
                    <a href="rent.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Rent</a>
                    <a href="spectacularPlace.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Spectacular Place</a>
                    <a href="shopping.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Shopping</a>
                    <a href="setting.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Setting</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Log</a>
                        <div class="dropdown-menu bg-transparent border-0">
